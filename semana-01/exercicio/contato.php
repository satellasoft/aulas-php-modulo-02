...
function getInput()
{
    return (object) [
        ...
        'mensagem' => str_replace([
            ...
            ';',
            '=',
        ], '', strip_tags(filter_input(INPUT_POST, 'txtMensagem', FILTER_SANITIZE_STRING)))
    ];
}
...
function validate($dados)
{
    ...
    if (strlen($dados->mensagem) < 10 || strlen($dados->mensagem) > 500) {
        return false;
    }
...
<body>
    ...
    <div class="max-width">
        <h1>Contato</h1>
        <?php if ($valido) : ?>
            <p>Olá, <span><?= $nome; ?></span>, recebemos a sua mensagem, em breve, um de nossos atendentes irá responde-lo.</p>
